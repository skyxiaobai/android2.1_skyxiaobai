...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 12:38:23 +0800
 * modify phoneNumber view related resource & add contacts button
   & cancel voiceButton show
 */
...
public class TwelveKeyDialer extends Activity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mDigitsBackground = r.getDrawable(R.drawable.blue);
        mDigitsEmptyBackground = r.getDrawable(R.drawable.blue);
...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 09:38:21 +0800
 * cancel voice button init
        initVoicemailButton();
 */
// End of Vanzo:zhouwenjie
...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 09:40:02 +0800
 * add dial button show & contacts implement
 */
        mDialButton.setEnabled(true);
        mContactsButton =mVoicemailDialAndDeleteRow.findViewById(R.id.contactsButton);
...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 09:41:45 +0800
 *  implement contacts function
 */
    private void AddShowContactsList() {
...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 09:45:38 +0800
 * cancel voice button invoke & add contact invoke
...
/* Vanzo:zhouwenjie on: Fri, 26 Nov 2010 09:47:42 +0800
 * cancel show states of dialButton
            if (mDialButton != null) {
